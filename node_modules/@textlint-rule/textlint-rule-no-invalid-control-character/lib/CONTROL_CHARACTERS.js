...
exports.CONTROL_CHARACTERS = exports.INVALID_CONTROL_CHARACTERS = void 0;
...
var INVALID_CONTROL_CHARACTERS = CONTROL_CHARACTERS.filter(CONTROL_CHARACTER => {
  var code = CONTROL_CHARACTER.code;
  return code !== "\r" && code !== "\n" && code !== "\t";
});
exports.INVALID_CONTROL_CHARACTERS = INVALID_CONTROL_CHARACTERS;
