...
var reporter = function reporter(context) {
  ...
  var checkNode = node => {
    ...
    var asciiControlCharacters = "\x00-\x08\x0B\x0C\x0E-\x1F\x7F";
    var c1ControlCharacters = "\x80-\x89\x8A-\x9F";
    var bidiFormattingCharacters = "\u202A-\u202E";
    var controlCharacterPattern = new RegExp("([".concat(asciiControlCharacters).concat(c1ControlCharacters).concat(bidiFormattingCharacters, "])"), "g");
    /**
