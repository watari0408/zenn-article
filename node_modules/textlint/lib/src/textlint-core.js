...
class TextLintCore {
    ...
    _mergeSetupOptions(options) {
        ...
        return Object.assign(Object.assign({}, options), { configBaseDir: configFileBaseDir, plugins: this.textlintKernelDescriptor.plugin.toKernelPluginsFormat(), rules: this.textlintKernelDescriptor.rule.toKernelRulesFormat(), filterRules: this.textlintKernelDescriptor.filterRule.toKernelFilterRulesFormat() });
    }
}
